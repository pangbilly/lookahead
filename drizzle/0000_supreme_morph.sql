...
CREATE UNIQUE INDEX "invitations_pending_unique" ON "invitations" USING btree ("organization_id","email") WHERE accepted_at is null and revoked_at is null;--> statement-breakpoint
